		...
		<div class="width-container">
			<div id="content-container">
				...
				<div class="content-container-anchor overlay-container-anchor">
					<h2 class="title-anchor title-heading">suíte ELITE</h2>
					<div class="room-featured">

						<div class="flexslider gallery-anchor">
							<ul class="slides">
								<li><a href="images/demo/elite-1.jpg" rel="prettyphoto[gallery-room]"><img src="images/demo/elite-1.jpg"></a></li>
								<li><a href="images/demo/elite-2.jpg" rel="prettyphoto[gallery-room]"><img src="images/demo/elite-2.jpg"></a></li>
							</ul>
