		...
		<div class="width-container">
			<div id="content-container">
				...
				<div class="content-container-anchor overlay-container-anchor">
					<h2 class="title-anchor title-heading">suíte LUMINE</h2>
					<div class="room-featured">

						<div class="flexslider gallery-anchor">
							<ul class="slides">
								<li><a href="images/demo/lumine-1.jpg" rel="prettyphoto[gallery-room]"><img src="images/demo/lumine-1.jpg"></a></li>
								<li><a href="images/demo/lumine-2.jpg" rel="prettyphoto[gallery-room]"><img src="images/demo/lumine-2.jpg"></a></li>
							</ul>
			...
			<div id="sidebar">
				<div class="content-container-anchor overlay-container-anchor">
					...
					<div class="grid4column">
						<span>R$</span>
						<h5 class="price-rooms">74,99</h5><br />
